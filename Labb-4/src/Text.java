	...
	public static void highScore(Graphics2D graphics) {
		...
		if (Game.s == null) {
			if (life > 0) {
				...
				graphics.drawString("74 gab", 300, fontSize * 2);

			} else {
				graphics.drawString(text, 300, fontSize + 230);
				graphics.drawString("74 gab", 300, fontSize + 260);
			}
			if (Game.totalBricks <= 0) {
				graphics.drawString(text, 300, fontSize + 230);
				graphics.drawString("74 gab", 300, fontSize + 260);
			...
			if (life > 0) {
				graphics.drawString(text, 300, fontSize);
				graphics.drawString("" + ScorePanel.Highscores[0], 300, fontSize * 2);

			} else {
				graphics.drawString(text, 300, fontSize + 230);
				graphics.drawString("" + ScorePanel.Highscores[0], 300, fontSize + 260);
			}
			if (Game.totalBricks <= 0) {
				graphics.drawString(text, 300, fontSize + 230);
				graphics.drawString("" + ScorePanel.Highscores[0], 300, fontSize + 260);
